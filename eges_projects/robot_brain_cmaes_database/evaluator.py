    ...
    def evaluate(
        ...
        for params in solutions:
            ...
            touch_weights = (params[len(self._active_hinges) * 2:len(
                self._active_hinges) * 3] * config.MAX_ATTRACTION_COEFFICIENT - config.MAX_ATTRACTION_COEFFICIENT)
            sensor_phase_offset = params[len(self._active_hinges) * 3:] * 2 * math.pi
